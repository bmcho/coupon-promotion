package com.bmcho.pointservice.controller.v1;

import com.bmcho.pointservice.config.interceptor.UserIdInterceptor;
import com.bmcho.pointservice.domain.Point;
import com.bmcho.pointservice.dto.PointDto;
import com.bmcho.pointservice.service.v1.PointService;
...
public class PointController {
    ...
    @PostMapping("/use")
    public ResponseEntity<PointDto.Response> usePoint(@Valid @RequestBody PointDto.UseRequest request) {
        Long userId = UserIdInterceptor.getCurrentUserId();
    ...
    public ResponseEntity<PointDto.Response> cancelPoint(@PathVariable Long pointId, @Valid @RequestBody PointDto.CancelRequest request) {
    ...
    public ResponseEntity<Page<PointDto.Response>> getPointHistory(@PathVariable Long userId, Pageable pageable) {
